    ...
    >
      <fieldset class="grid grid-cols-4 gap-6">
        <div class="col-span-full space-y-2 lg:col-span-1">
          <p class="text-xl font-semibold text-gray-700">Thông tin cá nhân</p>
        ...
        <div class="col-span-full grid grid-cols-6 gap-4 lg:col-span-3">
          ...
          <div class="col-span-full sm:col-span-2">
            <label class="text-sm font-medium text-gray-600" for="city">City</label>
            <input
              id="city"
              v-model="form.city"
              class="mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
          ...
          <div class="col-span-full sm:col-span-2">
            <label class="text-sm font-medium text-gray-600" for="state">State / Province</label>
            <input
              id="state"
              v-model="form.state"
              class="mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
          ...
          <div class="col-span-full sm:col-span-2">
            <label class="text-sm font-medium text-gray-600" for="zip">ZIP / Postal</label>
            <input
              id="zip"
              v-model="form.zip"
              class="mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
      ...
      <fieldset class="grid grid-cols-4 gap-6 rounded-md p-6 shadow-sm dark:bg-gray-50">
        ...
        <div class="col-span-full grid grid-cols-6 gap-4 lg:col-span-3">
          <div class="col-span-full sm:col-span-3">
            <label class="text-xs text-gray-600" for="username">Username</label>
            <input
              id="username"
          ...
          <div class="col-span-full">
            <label class="text-sm font-medium text-gray-600" for="bio">Bio</label>
            <textarea
              id="bio"
              v-model="form.bio"
              class="mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
          ...
          <div class="col-span-full">
            ...
            <div class="mx-auto max-w-lg">
              <label
                class="mb-2 block text-sm font-medium font-medium text-gray-600 text-gray-900 dark:text-white"
                for="user_avatar"
                >Upload file</label
              >
              <input
                id="user_avatar"
                class="block w-full cursor-pointer rounded-lg border border-gray-300 bg-gray-50 text-sm font-medium text-gray-600 text-gray-900 focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:placeholder-gray-400"
                type="file"
                aria-describedby="user_avatar_help"
              />
              <div
                id="user_avatar_help"
                class="mt-1 text-sm font-medium text-gray-500 text-gray-600 dark:text-gray-300"
              >
                Upload ảnh của người dùng. Kích thước tối đa 2MB.
              </div>
            </div>
          </div>
        </div>
