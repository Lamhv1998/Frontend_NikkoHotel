    ...
    >
      ...
      <fieldset class="grid grid-cols-4 gap-6 rounded-md p-6 shadow-sm dark:bg-gray-50">
        <div class="col-span-full space-y-2 lg:col-span-1">
          ...
          <p class="text-xs">Hình ảnh hoặc loại thành viên....</p>
        </div>
        <div class="col-span-full grid grid-cols-6 gap-4 lg:col-span-3">
          <div class="col-span-full sm:col-span-3">
            ...
            >
              <option value="" disabled>-- Chọn loại thành viên --</option>
              <option value="admin">ĐỒNG</option>
              <option value="user">BẠC</option>
              <option value="staff">VÀNG</option>
            </select>
          </div>
          <div class="col-span-full">
          ...
          <div class="col-span-full">
            ...
            <div class="mx-auto max-w-lg">
              ...
              <input
                id="user_avatar"
                class="block w-full cursor-pointer rounded-lg border border-gray-300 bg-gray-50 text-sm font-medium text-gray-600 focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:placeholder-gray-400"
                type="file"
